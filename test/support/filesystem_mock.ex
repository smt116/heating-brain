defmodule Collector.FilesystemMock do
  ...
  @gpio_path Application.get_env(:heating_brain, :gpio_base_path)
  @gpio_export_path Path.join([@gpio_path, "export"])
  @relays_map Application.get_env(:heating_brain, :relays_map)
  @sensors_map Application.get_env(:heating_brain, :sensors_map)
  @w1_bus_path Application.get_env(:heating_brain, :w1_bus_master1_path)
  ...
  def set_sensor(label, val, opts \\ []) when is_atom(label) and is_float(val) do
    id =
      Application.get_env(:heating_brain, :sensors_map)
